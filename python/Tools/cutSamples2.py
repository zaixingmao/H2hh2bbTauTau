...
xLabels = ['processedEvents', 'PATSkimmedEvents', 'atLeastOneDiTau', 'ptEta1', 'ptEta2', 'tau1Hadronic', 
	   'tau2Hadronic','muonVeto1', 'muonVeto2', 'eleVeto1', 'eleVeto2', 'isolation1', 'relaxed', 'iso', 'OS']
...
preVarList = ['EVENT', 'RUN', 'svMass', 'LUMI', 'svPt', 'svEta', 'svPhi', 'J1Pt', 'J1Eta','J1Phi', 'J1Mass', 'NBTags', 'iso1', 'iso2', 'mJJ', 'J2Pt', 'J2Eta','J2Phi', 'J2Mass','pZeta', 'pZ', 'm1', 'm2',
           ...
           'Rho', 'againstMuonLoose1', 'againstMuonLoose2', 'againstMuonMedium1', 'againstMuonMedium2',
           'againstMuonTight1','againstMuonTight2',
          ]
...
for iSample, iLocation in sampleLocations:
    ...
    iTree.Branch("run", run, "run/F")
    iTree.Branch("lumi", lumi, "lumi/F")
    iTree.Branch("evt", event, "event/F")
