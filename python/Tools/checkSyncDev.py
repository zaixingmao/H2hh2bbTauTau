...
ifile2 = '/afs/cern.ch/user/k/kandroso/public/HTohhSync/sync_GGH_hh_bbtt_tautau.root'


iFile1 = r.TFile(ifile1)
iTree1 = iFile1.Get('TauCheck')
total1 = iTree1.GetEntries()

iFile2 = r.TFile(ifile2)
iTree2 = iFile2.Get('syncTree')
