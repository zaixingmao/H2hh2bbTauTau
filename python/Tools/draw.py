...
#     output = 'python  ~/myScripts/H2hh2bbTauTau/python/Tools/drawVarsData_Xsquare.py --location /scratch/zmao/relaxed_regression3/new_XS  --signal H350' #%region
...
#     output = 'python  ~/myScripts/H2hh2bbTauTau/python/Tools/drawVarsData_KS_CheckFlat.py --location /scratch/zmao/relaxed_regression3/new_KS_%s  --signal H350' %region
