...
#     varList = ['svMass', 'dRTauTau', 'svPt', 'dRhh', 'mJJReg', 'metTau2DPhi', 'metJetPairDPhi','CSVJ1']
    varList = ['svMass', 'dRTauTau', 'mJJReg', 'metTau2DPhi']
...
#     tool.addFiles(ch=bkg2Chain, dirName="/hdfs/store/user/zmao/ZZ_3-SUB-TT", knownEventNumber=0, maxFileNumber=-1)
    ...
    print "QCD:\t\t%.2f" %(bkgChain.GetEntries()*0.025)
