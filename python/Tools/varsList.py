...
varsRange = { 
#             'fMass': (15, 200, 800, 10000, 100, True),
#             'pt1': (20, 0, 400, 10000, 100, True),
#             'pt2': (15, 0, 300, 10000, 100, True),
#             'iso1':(25, 0, 10, 20000, 600, True),
#             'iso2':(25, 0, 10, 20000, 600, True),
#             'eta1': (20, -3.14, 3.14, 50000, 100, True), 
#             'eta2': (20, -3.14, 3.14, 50000, 100, True), 
#             'NBTags': (6, 0, 5, 2000, 100, True), 
#             'J1CSVbtag': (12, 0, 1.2, 100000, 100, True),
#             'J1Eta': (20, -3.14, 3.14, 50000, 100, True),
#             'J1Pt': (20, 0, 400, 5000, 100, True),
#             'J2CSVbtag': (12, 0, 1.2, 100000, 100, True),
#             'J2Eta': (20, -3.14, 3.14, 50000, 100, True),
#             'J2Pt': (15, 0, 250, 10000, 100, True),
#             'J3CSVbtag':(12, 0, 1.2, 50000, 100, True),
#            'J3Eta': (20, -3.14, 3.14, 50000, 100, True),
#             'J3Pt': (15, 0, 250, 5000, 100, True),
#             'J4CSVbtag':(12, 0, 1.2, 50000, 100, True),
#             'J4Eta': (20, -3.14, 3.14, 10000, 100, True),
#             'J4Pt': (15, 0, 250, 5000, 100, True),
#             'svMass': (15, 0, 600, 5000, 100, True),
             'mJJ': (15, 50, 200, 25, 800, False),
             'mJJReg': (15, 50, 200, 25, 800, False),
#             'ptJJ': (15, 0, 600, 5000, 100, True),
#             'etaJJ': (20, -3.14, 3.14, 50000, 100, True),
#             'dPhiMetTau1': (10, 0, 3.14, 50000, 100, True),
#             'dPhiMetTau2': (10, 0, 3.14, 50000, 100, True),
#             'dPhiMetJet1': (10, 0, 3.14, 50000, 100, True),
#             'dPhiMetJet2': (10, 0, 3.14, 50000, 100, True),
#             'dPhiMetTauPair': (10, 0, 3.14, 50000, 100, True),
#             'dPhiMetJetPair': (10, 0, 3.14, 50000, 100, True),
#             'dPhiMetSVTauPair': (10, 0, 3.14, 50000, 100, True),
#             'dRTauTau': (20, 0, 6.28, 5000, 100, True), 
#             'dRJJ': (20, 0, 6.28, 10000, 100, True),
#             'dRhh': (20, 0, 6.28, 10000, 100, True),
            }
