...
varsRange = { 
#             'fMass': (15, 200, 800, 10000, 100, True, True),
#             'pt1': (20, 30, 400, 10000, 100, True, True, 'GeV'),
#             'pt2': (15, 30, 400, 10000, 100, True, True, 'GeV'),
...
#             'svMass': (10, 0, 600, 5000, 100, True, True),
#             'svPt': (15, 0, 600, 5000, 100, True, True),
#              'mJJ': (20, 0, 400, 30000, 100, True, True),
#              'mJJReg': (10, 0, 400, 30000, 100, True, True),
#              'met': (20, 0, 400, 30000, 100, True, True),
#             'ptJJ': (15, 0, 600, 5000, 100, True, True),
#             'etaJJ': (20, -3.14, 3.14, 50000, 100, True, True),
#             'dPhiMetTau1': (10, 0, 3.14, 60, 800, False, True),
#             'dPhiMetTau2': (10, 0, 3.14, 60, 600, False, True),
#             'dPhiMetJet1': (10, 0, 3.14, 60, 600, False, True),
#             'dPhiMetJet2': (10, 0, 3.14, 60, 400, False, True),
#             'dPhiMetTauPair': (10, 0, 3.14, 60, 800, False, True),
#             'dPhiMetJetPair': (10, 0, 3.14, 60, 600, False, True),
#             'dPhiMetSVTauPair': (10, 0, 3.14, 60, 800, False, True),
#             'dRTauTau': (20, 0, r.TMath.Pi(), 5000, 100, True, True), 
#             'dPhiTauTau': (20, 0, r.TMath.Pi(), 5000, 500, True, True), 
#             'dEtaTauTau': (20, 0, r.TMath.Pi(), 5000, 500, True, True), 
#             'dRJJ': (20, 0, 6.28, 10000, 100, True, True),
#             'dRhh': (20, 0, 6.28, 10000, 100, True, True),
#             'BDT_EWK': (20, -1., 1., 10000, 100, True, True),
#             'BDT_QCD': (20, -1., 1., 10000, 100, True, True),
#             'BDT_both': (20, -1., 1., 10000, 100, True, True, 'BDT_Value'),
